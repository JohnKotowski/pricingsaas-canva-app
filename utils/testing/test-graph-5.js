...
const config = {
  ...
  chartType: 'grouped',
  title: 'Packaging changes 2024 Q1 - 2025 Q4'
};

async function test() {
  console.log('📈 Testing graph #5: Packaging Changes Over Time\n');
  ...
  const filepath = path.join(tempDir, '5-packaging-changes-over-time.png');
